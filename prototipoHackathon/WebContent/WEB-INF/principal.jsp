    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="main-nav" class="collapse navbar-collapse">
        <ul class="nav navbar-nav" id="mainNav">
          ...
          <li><a href="#Features" class="scroll-link">Características</a></li>
...
<section id="Features" class="page-section colord">
  <div class="container">
    <div class="row"> 
	  ...
	  <div class="box-item">
	  <img src="images/moiya/cursovirtual.jpg" alt="" />
        <h3>Crear Cursos / Temas</h3>
	  ...
	  <div class="box-item">
	  <a href="Aprender">
	  <img src="images/moiya/proponer.png" alt="" />
        <h3>Ir a Cursos</h3>
        <p>Aprenda de manera práctica y dinámica.</p>
        </a>
      </div>
	   </div>
      <!-- end: --> 
      ...
      <div class="col-md-3 text-center">
	  <div class="box-item">
	  <img src="images/moiya/chat.jpg" alt="" />
        <h3>Chat</h3>        
        <p>Converse con el asistente virtual.</p>
      </div>
	   </div>
      <!-- end:-->
      ...
      <div class="col-md-3 text-center">
	  <div class="box-item">
	  <i class="circle"> <img src="images/moiya/news.png" alt="" /></i>
        <h3>Noticias</h3>
        <p>Mire las últimas Noticias.</p>
      </div>
	   </div>-->
      <!-- end: --> 
